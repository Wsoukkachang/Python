#This is a script that detects loops in linked list, will return false if not circular or has no loops.
...
list_without_loop = LinkedList([-4, 7, 2, 5, -1])

# Create another circular linked list - small_loop
