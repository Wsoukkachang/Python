...
# Script that gives all possible combinations of keypad presses.
...
print(keypad(0)) # should not print anything

print(keypad(23)) # should print all possible combinations